...
#import "ViewRecordMainVC.h"
#import "SGPagingView.h"
#import "ViewRecordVC.h"
@interface ViewRecordMainVC ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentView *pageContentView;
@end

@implementation ViewRecordMainVC
- (void)dealloc {
...
- (void)setupPageView {
    ...
    for (int i =0; i<titleArr.count; i++) {
        ViewRecordVC *oneVC = [[ViewRecordVC alloc] init];
        oneVC.type=i;
